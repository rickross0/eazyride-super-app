...
const createStyles = (C) => StyleSheet.create({
  ...
  enteredBadge: { backgroundColor: 'rgba(16,185,129,0.15)', borderRadius: 12, padding: 16, marginTop: 16, alignItems: 'center', width: '100%' },
  enteredText: { color: '#10b981', fontWeight: '800', fontSize: 16 },
  enteredSubtext: { color: '#34d399', fontSize: 13, marginTop: 4 },
  ...
  entryRight: {},
  winnerBadge: { backgroundColor: 'rgba(16,185,129,0.2)', color: '#10b981', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, fontWeight: '700', fontSize: 12 },
  completedBadge: { backgroundColor: 'rgba(128,128,128,0.2)', color: '#c0c0c0', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, fontWeight: '600', fontSize: 12 },
  pendingBadge: { backgroundColor: 'rgba(245,158,11,0.2)', color: '#fbbf24', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, fontWeight: '700', fontSize: 12 },
});
